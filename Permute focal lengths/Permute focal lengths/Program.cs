...
namespace Permute_focal_lengths
{
    class Program
    {
        ...
        {                            
         IList<double> d1forMx = new List<double>() { };
         IList<double> d2forMx = new List<double>() { };
         IList<double> d1forMy = new List<double>() { };
         IList<double> d2forMy = new List<double>() { };
         IList<double> d1forMxratioMy = new List<double>() { };
         IList<double> d2forMxratioMy = new List<double>() { };
         IList<double> d1forInputMax = new List<double>() { };
         IList<double> d2forInputMax = new List<double>() { };
         IList<double> d1forInputMin = new List<double>() { };
         IList<double> d2forInputMin = new List<double>() { };
                    
        // 3 focal lengths must have equal number of elemnets otherwise there will be an exception for arguments out of range 

         IList<double> focallength1 = new List<double>() { 130, 140, 150 }; // Initialize List for focal length 1
         IList<double> focallength2 = new List<double>() { -19, -20, -21 }; // Initialize List for focal length 2
         IList<double> focallength3 = new List<double>() { 70, 71, 72 };     // Initialize List for focal length 3
